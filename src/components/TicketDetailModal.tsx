...
export default function TicketDetailModal({ isOpen, onClose, ticket, members, projectId, onUpdate }: TicketDetailModalProps) {
    ...
    const isReporter = String(ticket.reporter?._id || ticket.reporter) === String(user?._id);
                        ...
                        <div className="flex gap-1">
                            ...
                            {isReporter && (
                                <Button
                                    ...
                                    className="w-8 h-8 p-0 rounded-lg hover:bg-red-50 text-slate-400 hover:text-red-500 group transition-colors"
                                    title="Delete Ticket"
                                >
