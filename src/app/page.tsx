            ...
            <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled || isMenuOpen ? 'py-4 glass' : 'py-6 bg-transparent'}`}>
                <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <Link href="/register" className="px-5 py-2.5 rounded-xl bg-white text-slate-900 font-bold text-sm hover:bg-emerald-400 transition-all active:scale-95">
                            Get Started
                        </Link>
                    </div>
                ...
                {isMenuOpen && (
                    <div className="md:hidden absolute top-full left-0 w-full glass border-t border-white/5 p-6 space-y-4 animate-in slide-in-from-top-4 duration-300 flex flex-col">
                        ...
                        <Link href="/register" onClick={() => setIsMenuOpen(false)} className="w-full py-4 rounded-2xl bg-gradient-to-r from-violet-600 to-emerald-500 text-white font-black text-center text-lg active:scale-95 transition-all">
                            Get Started Free
                        </Link>
                    </div>
                )}
            ...
            <main className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-white/10 text-emerald-400 text-[10px] font-black uppercase tracking-[0.2em] mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <h1 className="text-6xl md:text-8xl font-black tracking-tight text-white mb-8 leading-[0.95] animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
                            Manage Projects with <span className="text-gradient">Precision.</span>
                        </h1>
                        ...
                        <p className="text-xl md:text-2xl text-slate-400 font-medium mb-12 max-w-2xl animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200">
                            dhaniyaa is the next-gen platform for engineering teams to plan, track, and collaborate on complex software projects.
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
                            <Link href="/register" className="px-8 py-4 rounded-2xl bg-gradient-to-r from-violet-600 to-emerald-500 text-white font-black text-lg shadow-2xl shadow-violet-600/20 hover:shadow-emerald-500/30 hover:scale-[1.02] transition-all flex items-center justify-center gap-3 active:scale-95 group">
                                Start Building Now
            ...
            <section id="features" className="py-32 relative bg-slate-900/50">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-5xl font-black text-white mb-4">Everything you need to <span className="text-violet-400">scale.</span></h2>
                        <p className="text-slate-400 font-bold tracking-wide uppercase text-xs">A comprehensive suite of collaboration tools</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            { icon: Rocket, color: 'text-amber-400', title: 'Sprint Velocity', desc: 'Interactive burn-down charts and sprint reports to track team performance.' },
            ...
            <section className="py-40 relative">
                <div className="max-w-5xl mx-auto px-6">
                    <div className="glass p-12 md:p-20 rounded-[48px] border border-white/10 text-center relative overflow-hidden group">
                        ...
                        <h2 className="text-4xl md:text-6xl font-black text-white mb-8 relative z-10">Ready to transform your <br /><span className="text-emerald-400">workflow?</span></h2>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                            <Link href="/register" className="px-10 py-5 rounded-[24px] bg-white text-slate-900 font-extrabold text-xl hover:bg-emerald-400 transition-all active:scale-95">
                                Join dhaniyaa Free
                            </Link>
                        </div>
                    </div>
            ...
            <footer className="py-20 border-t border-white/5">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-10">
                    <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-600 to-emerald-500 flex items-center justify-center text-white">
